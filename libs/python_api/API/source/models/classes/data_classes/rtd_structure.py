...
class RTD:
    packet_begin: float = 1
    # package beginning check-byte (B)
    byte_res1: Tuple[float, ...] = (0,) * PADDING_RES1_LENGTH
    ...
    joint_state: Tuple[float, ...] = (0,) * JOINTS_COUNT
    # 0 - joint brakes applied, 1 - joint brakes released (6B)
    res_bytes3: Tuple[float, ...] = (0,) * 2
    # padding (2B)
    ...
    byte_res3: Tuple[float, ...] = (0,) * (3)
    # padding for packet end, can be used for debug values (3B)
    packet_end: float = 1
