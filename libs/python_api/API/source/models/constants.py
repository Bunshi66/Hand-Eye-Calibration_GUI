...
RPMP_ROTATION_SPEED_LIMITS = (0, 6.28)  # rad/s
RPMP_ROTATION_ACCEL_LIMITS = (0, 12.56)  # rad/s^2
POSITION_ORIENTATION_LENGTH = 6
WP_COUNT_LIMITS = (0, None)

# PACK/UNPACK FORMATS
CTRLR_RPMP_ADD_WP_MOVEL_CMD_PACK_FORMAT = "@id3d3ddddd80x"
CTRLR_RPMP_ADD_WP_MOVEP_CMD_PACK_FORMAT = "@id3d3ddddd80x"
CTRLR_RPMP_ADD_WP_MOVEC_CMD_PACK_FORMAT = "@id3d3ddddd3d3ddddd"
CTRLR_RPMP_ADD_WP_MOVEJ_CMD_PACK_FORMAT = "@id6d6d6d16x"
