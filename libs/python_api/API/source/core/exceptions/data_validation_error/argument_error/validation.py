...
def validate_literal(  # noqa: C901
    type_: LiteralType,
    value: (
        CompareSigns
        | JogDirection
    ...
    elif type_ == "reference_frame":
        if value not in ("base", "tcp"):
            raise err.ArgValueError(value)
...
def validate_index(index: int, range_: Iterable[int]):
